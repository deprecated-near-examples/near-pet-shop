...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/REMOVEweb3.min.js":[function(require,module,exports) {
var define;
...
require = function t(e, n, r) {
  ...
  7: [function (t, e, n) {
    ...
    d.prototype._requireType = function (t) {
      ...
      return e.isDynamicArray(t) ? function () {
        ...
        return function () {
          var t = 2;
          if (e.isDynamicArray(a)) for (var i = 1; i < n.length; i++) {
  ...
  20: [function (t, e, n) {
    var r = t("bignumber.js"),
      ...
      if (D(t)) return g(+t);
      if (I(t)) return g(t);
      if ("object" == _typeof(t)) return l(JSON.stringify(t));
      ...
      return "function" == typeof t;
        ...
        T = function T(t) {
      return null !== t && !(t instanceof Array) && "object" == _typeof(t);
    },
        D = function D(t) {
  ...
  28: [function (t, e, n) {
    var r = t("./formatters"),
      ...
      var e = function e(_e) {
        var n;
        _e.property ? (t[_e.property] || (t[_e.property] = {}), n = t[_e.property]) : n = t, _e.methods && _e.methods.forEach(function (e) {
          e.attachToObject(n), e.setRequestManager(t._requestManager);
        }), _e.properties && _e.properties.forEach(function (e) {
          e.attachToObject(n), e.setRequestManager(t._requestManager);
        });
      };
  ...
  29: [function (t, e, n) {
    var r = t("./formatters"),
      ...
      var e = function e(_e2, n) {
        return _e2 ? t.callbacks.forEach(function (t) {
          t(_e2);
  ...
  43: [function (t, e, n) {
    var r = t("../method"),
      ...
      var t = function t(_t2) {
        ...
        switch (e) {
          case "latest":
            return _t2.shift(), this.params = 0, "eth_newBlockFilter";

          case "pending":
            return _t2.shift(), this.params = 0, "eth_newPendingTransactionFilter";
  ...
  48: [function (t, e, n) {
    var r = t("./formatters"),
        ...
        i = 1,
        a = function a(t) {
      var e = function e(_e4, n) {
        return _e4 ? t.callbacks.forEach(function (t) {
          t(_e4);
  ...
  49: [function (t, e, n) {
    var r = t("./iban"),
        ...
        i = function i(t, e, n, o, _i) {
      var c = new r(n);
      if (!c.isValid()) throw new Error("invalid iban address");
      if (c.isDirect()) return a(t, e, c.address(), o, _i);
      ...
      t.icapNamereg().addr(c.institution(), function (n, r) {
        return s(t, e, r, o, c.client(), _i);
      });
    },
        a = function a(t, e, n, r, o) {
  ...
  50: [function (t, e, n) {
    !function (r, o, i) {
      "object" == _typeof(n) ? e.exports = n = o(t("./core"), t("./enc-base64"), t("./md5"), t("./evpkdf"), t("./cipher-core")) : "function" == typeof define && define.amd ? define(["./core", "./enc-base64", "./md5", "./evpkdf", "./cipher-core"], o) : o(r.CryptoJS);
    }(this, function (t) {
      return function () {
        var e = t,
            n = e.lib,
  ...
  51: [function (t, e, n) {
    !function (r, o) {
      "object" == _typeof(n) ? e.exports = n = o(t("./core")) : "function" == typeof define && define.amd ? define(["./core"], o) : o(r.CryptoJS);
    }(this, function (t) {
  ...
  52: [function (t, e, n) {
    !function (t, r) {
      "object" == _typeof(n) ? e.exports = n = r() : "function" == typeof define && define.amd ? define([], r) : t.CryptoJS = r();
    }(this, function () {
  ...
  55: [function (t, e, n) {
    !function (r, o, i) {
      "object" == _typeof(n) ? e.exports = n = o(t("./core"), t("./sha1"), t("./hmac")) : "function" == typeof define && define.amd ? define(["./core", "./sha1", "./hmac"], o) : o(r.CryptoJS);
    }(this, function (t) {
      return function () {
        var e = t,
            n = e.lib,
  ...
  56: [function (t, e, n) {
    !function (r, o, i) {
      "object" == _typeof(n) ? e.exports = n = o(t("./core"), t("./cipher-core")) : "function" == typeof define && define.amd ? define(["./core", "./cipher-core"], o) : o(r.CryptoJS);
    }(this, function (t) {
      return function (e) {
        var n = t,
            r = n.lib,
  ...
  77: [function (t, e, n) {
    !function (r, o, i) {
      "object" == _typeof(n) ? e.exports = n = o(t("./core"), t("./sha256")) : "function" == typeof define && define.amd ? define(["./core", "./sha256"], o) : o(r.CryptoJS);
    }(this, function (t) {
      return function () {
        var e = t,
            n = e.lib,
  ...
  79: [function (t, e, n) {
    !function (r, o, i) {
      "object" == _typeof(n) ? e.exports = n = o(t("./core"), t("./x64-core")) : "function" == typeof define && define.amd ? define(["./core", "./x64-core"], o) : o(r.CryptoJS);
    }(this, function (t) {
      return function (e) {
        var n = t,
            r = n.lib,
  ...
  80: [function (t, e, n) {
    !function (r, o, i) {
      "object" == _typeof(n) ? e.exports = n = o(t("./core"), t("./x64-core"), t("./sha512")) : "function" == typeof define && define.amd ? define(["./core", "./x64-core", "./sha512"], o) : o(r.CryptoJS);
    }(this, function (t) {
      return function () {
        var e = t,
            n = e.x64,
  ...
  84: [function (t, e, n) {
    !function (t) {
      ...
      var p = "object" == _typeof(n) && n,
          h = "object" == _typeof(e) && e && e.exports == p && e,
          d = "object" == (typeof global === "undefined" ? "undefined" : _typeof(global)) && global;
    ...
    !function (t) {
      ...
      function n(t) {
        ...
        return e.another = n, e.ROUND_UP = 0, e.ROUND_DOWN = 1, e.ROUND_CEIL = 2, e.ROUND_FLOOR = 3, e.ROUND_HALF_UP = 4, e.ROUND_HALF_DOWN = 5, e.ROUND_HALF_EVEN = 6, e.ROUND_HALF_CEIL = 7, e.ROUND_HALF_FLOOR = 8, e.EUCLID = 9, e.config = e.set = function () {
          ...
          function n(t, e, n, r) {
            var o, i;
            if (n != r) i = n > r ? 1 : -1;else for (o = i = 0; o < n; o++) {
              if (t[o] != e[o]) {
                i = t[o] > e[o] ? 1 : -1;
                break;
              }
            ...
            if (D[p] > (T[p] || 0) && l--, O < 0) b.push(1), h = !0;else {
              ...
              do {
                if (d = 0, f = n(D, x, F, k), f < 0) {
                  if (B = x[0], F != k && (B = B * u + (x[1] || 0)), d = m(B / A), d > 1) for (d >= u && (d = u - 1), y = t(D, d, u), g = y.length, k = x.length; 1 == n(y, x, g, k);) {
                    d--, o(y, F < g ? I : D, g, u), g = y.length, f = 1;
                  } else 0 == d && (f = d = 1), y = D.slice(), g = y.length;
                  if (g < k && (y = [0].concat(y)), o(x, y, k, u), k = x.length, f == -1) for (; n(D, x, F, k) < 1;) {
          ...
          if (f = r(f), l = r(l), p = p.slice(), u = f - l) {
            ...
            a.reverse();
          } else for (i = (s = (u = p.length) < (n = h.length)) ? u : n, u = n = 0; n < i; n++) {
            if (p[n] != h[n]) {
              s = p[n] < h[n];
              break;
            }
          ...
          if (f = Math.sqrt(+c), 0 == f || f == 1 / 0 ? (n = o(u), (n.length + l) % 2 == 0 && (n += "0"), f = Math.sqrt(n), l = r((l + 1) / 2) - (l < 0 || l % 2), f == 1 / 0 ? n = "1e" + l : (n = f.toExponential(), n = n.slice(0, n.indexOf("e") + 1) + l), i = new e(n)) : i = new e(f + ""), i.c[0]) for (l = i.e, f = l + p, f < 3 && (f = 0);;) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/REMOVEweb3.min.js"], null)
//# sourceMappingURL=/REMOVEweb3.min.6cdc5486.js.map